                ...
                <div class="flex items-center px-4">
                    ...
                    <nav id="nav-menu"
                        ...
                        <ul class="block lg:flex">
                            ...
                            <li class="group">
                                <a href="#client"
                                    class="text-base text-dark py-2 mx-8 flex group-hover:text-primary">Klien</a>
                            </li>
                            <li class="group">
                                <a href="#blog"
            ...
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4 lg:w-1/2">
                    <h1 class="text-base font-semibold text-primary md:text-xl">Halo Semua 👋, Saya <span
                            class="block font-bold text-dark text-3xl mt-1 lg:w-1/2">Achmad Zakariya</span></h1>
                    <h2 class="font-medium text-secondary text-lg mb-5 lg:text-2xl">Mahasiswa <span
                            class="text-dark">Teknik Informatika</span></h2>
                    <p class="font-normal text-slate-400 mb-10 leading-relaxed">Orang lain gak akan bisa paham <i
                            class="text-dark">struggle</i> dan masa sulitnya kita, yang mereka ingin tahu hanya bagian
                        <i class="text-dark">success stories</i>-nya saja. Berjuanglah untuk diri sendiri walaupun gak ada yang
                ...
                <div class="w-full self-end px-4 lg:w-1/2">
                    <div class="relative mt-10 lg:mt-10 lg:right-0">
                        <img src="img/foto-formal.png" alt="Achmad Zakariya" class="max-w-full mx-auto">
                        <span
                            class="absolute -bottom-0 -z-10 -top-1 left-1/2 -right-1/2 -translate-x-1/2 md:scale-125 md:-right-1/2 lg:w-1/2 lg:top-12 lg:-right-1/2">
        ...
        <div class="container">
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4 mb-10 lg:w-1/2">
                    ...
                    <h2 class="font-bold text-dark text-3xl mb-5 max-w-lg">Sinopsis</h2>
                    <p class="font-medium text-base text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. At modi vel repudiandae aspernatur
                        beatae cumque ipsa a magnam voluptas odio necessitatibus ipsam maxime, in illo expedita aperiam
                        harum fugit quas!</p>
                </div>
                <div class="w-full px-4 lg:w-1/2">
                    <h3 class="font-semibold text-dark text-2xl mb-4 lg:text-3xl lg:pt-10">Mari Berteman</h3>
                    <p class="font-medium text-base text-secondary mb-6">Lorem ipsum dolor sit amet consectetur
                        adipisicing elit. Qui deleniti corporis nesciunt non!
                        Placeat ipsum distinctio fugiat error, impedit facilis laboriosam corrupti aut numquam? Officia
                        corporis placeat iure ipsam quo.</p>
            ...
            <div class="w-full px-4 flex flex-wrap justify-center">
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="rounded-md shadow-md overflow-hidden">
                        <img src="img/portfolio/p-1.png" alt="system-management-tosepatu" class="w-full">
                    </div>
                    <h3 class="font-semibold text-xl text-dark mt-5 mb-3">Sistem Informasi Tosepatu Berbasis Website
                        dan Mobile</h3>
                    <p class="font-medium text-base text-secondary">Lorem ipsum dolor sit, amet consectetur adipisicing
                        elit. Quidem cum autem nihil aliquam enim sit
                        iure labore voluptas rem delectus harum odit fugiat odio alias, a exercitationem ut illum fugit!
                    </p>
                </div>
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="rounded-md shadow-md overflow-hidden">
                        <img src="img/portfolio/p-2.png" alt="system-management-tosepatu" class="w-full">
                    </div>
                    <h3 class="font-semibold text-xl text-dark mt-5 mb-3">Web Design Toko Burger</h3>
                    <p class="font-medium text-base text-secondary">Lorem ipsum dolor sit, amet consectetur adipisicing
                        elit. Quidem cum autem nihil aliquam enim sit
                        iure labore voluptas rem delectus harum odit fugiat odio alias, a exercitationem ut illum fugit!
                    </p>
                ...
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="rounded-md shadow-md overflow-hidden">
                        <img src="img/portfolio/p-3.png" alt="system-management-tosepatu" class="w-full">
                    </div>
                    <h3 class="font-semibold text-xl text-dark mt-5 mb-3">Sistem Informasi Warung Makan Pahlawan Berbasis Dekstop</h3>
                    <p class="font-medium text-base text-secondary">Lorem ipsum dolor sit, amet consectetur adipisicing
                        elit. Quidem cum autem nihil aliquam enim sit
                        iure labore voluptas rem delectus harum odit fugiat odio alias, a exercitationem ut illum fugit!
                    </p>
                ...
                <div class="mb-12 p-4 md:w-1/2">
                    <div class="rounded-md shadow-md overflow-hidden">
                        <img src="img/portfolio/p-4.png" alt="system-management-tosepatu" class="w-full">
                    </div>
                    <h3 class="font-semibold text-xl text-dark mt-5 mb-3">Website Design Toko Online OlZhop Store</h3>
                    <p class="font-medium text-base text-secondary">Lorem ipsum dolor sit, amet consectetur adipisicing
                        elit. Quidem cum autem nihil aliquam enim sit
                        iure labore voluptas rem delectus harum odit fugiat odio alias, a exercitationem ut illum fugit!
                    </p>
        ...
        <div class="container">
            <div class="w-full px-4">
                <div class="mx-auto text-center mb-16">
                    ...
                    <h2 class="font-bold text-white text-3xl mb-4">Yang Pernah Bekerjasama</h2>
            ...
            <div class="w-full px-4">
                <div class="flex flex-wrap items-center justify-center">
                    <a href="https://www.instagram.com/humaspolije" target="_blank"
                        ...
                        <img src="img/clients/logo-polije.png" alt="polije">
                    </a>
                    <a href="https://www.instagram.com/hmjti_polije" target="_blank"
                        class="max-w-[100px] mx-4 mb-5 py-4 grayscale opacity-60 transition hover:grayscale-0 hover:opacity-100 lg:mx-5 xl:mx-7 xl:mt-0 xl:mb-0">
                        <img src="img/clients/logo-hmjti.png" alt="hmjti_polije">
                    </a>
                    <a href="https://www.instagram.com/coolinary_pos" target="_blank"
                        class="max-w-[100px] mx-4 py-4 grayscale opacity-60 transition hover:grayscale-0 hover:opacity-100 lg:mx-5 xl:mx-6">
                        <img src="img/clients/logo-cp.png" alt="coolinarypos">
                    </a>
                    <a href="https://www.instagram.com/tosepatu.kc" target="_blank"
                        class="max-w-[150px] mx-4 py-4 grayscale opacity-60 transition hover:grayscale-0 hover:opacity-100 lg:mx-5 xl:mx-6 xl:mt-0">
                        <img src="img/clients/logo_ToSepatu-no-bg.png" alt="tosepatu">
                    </a>
                    <a href="https://www.instagram.com/krbteam_" target="_blank"
                        class="max-w-[180px] mx-4 py-4 grayscale opacity-60 transition hover:grayscale-0 hover:opacity-100 lg:mx-5 xl:mx-6 xl:mt-0">
                        <img src="img/clients/logo-krb.png" alt="krbteam">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-wrap">
                <div class="w-full px-4 lg:w-1/2 xl:w-1/3">
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-10">
                        <img width="360" height="200" src="img/blog/programming-1.jpg" alt="programming"
                            class="w-full">
                        <div class="py-8 px-6">
                            <h3>
                                <a href="/"
                                    class="block mb-3 font-semibold text-xl text-dark hover:text-primary truncate">Tips
                                    Belajar Programming</a>
                            </h3>
                            <p class="font-medium text-base text-secondary mb-6">Lorem ipsum dolor sit amet,
                                consectetur adipisicing elit. Provident beatae rerum odio eos
                                ullam quisquam iste delectus itaque, in magnam accusantium quasi inventore reiciendis
                                at. Ipsa alias iusto iure dolorum.</p>
                            <a href="/"
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-1/3">
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-10">
                        <img width="360" height="200" src="img/blog/bitcoin-1.jpg" alt="cryptocurency"
                            class="w-full">
                        <div class="py-8 px-6">
                            <h3>
                                <a href="/"
                                    class="block mb-3 font-semibold text-xl text-dark hover:text-primary truncate">Apa
                                    Itu Cryptocurency?</a>
                            </h3>
                            <p class="font-medium text-base text-secondary mb-6">Lorem ipsum dolor sit amet,
                                consectetur adipisicing elit. Provident beatae rerum odio eos
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-1/3">
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-10">
                        <img width="360" height="200" src="img/blog/tiktok-1.jpg" alt="tiktok-bussines"
                            class="w-full">
                        <div class="py-8 px-6">
                            <h3>
                                <a href="/"
                                    class="block mb-3 font-semibold text-xl text-dark hover:text-primary truncate">Bisnis
                                    Di Tiktok Sekarang!</a>
                            </h3>
                            <p class="font-medium text-base text-secondary mb-6">Lorem ipsum dolor sit amet,
                                consectetur adipisicing elit. Provident beatae rerum odio eos
                                ullam quisquam iste delectus itaque, in magnam accusantium quasi inventore reiciendis
    ...
    <footer class="bg-dark pt-24 pb-12">
        <div class="container">
            ...
            <div class="w-full pt-10 border-t border-slate-700">
                ...
                <p class="font-medium text-sm text-slate-500 text-center">@2023 | Dibuat oleh <a href="https://www.instagram.com/achmdzkry_" target="_blank" class="font-bold text-primary">Achmad Zakariya</a></p>
            </div>
        </div>
    </footer>
    {{-- footer section end --}}
